...
/** 
 * CUSTOM: Don't cache WSDL files on dev sites
 */
 ...
 */
/*
#$conf['proxy_server'] = 'ftp-proxy-test.fss.gsa.gov';
$conf['proxy_server'] = '172.18.111.5';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_interact_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_interact_dd.inc';
}
// </DDSETTINGS>
